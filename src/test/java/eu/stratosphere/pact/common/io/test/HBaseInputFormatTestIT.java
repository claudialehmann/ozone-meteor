...
public class HBaseInputFormatTestIT {
	...
	public void setUp() throws Exception
	{
		...
		when(tableMock.getConfiguration()).thenReturn(new Configuration());
		when(scanMock.getTimeRange()).thenReturn(new TimeRange());
	}
	...
	public void shouldOpenFormat() throws IOException
	{
		...
		verify(this.recordReaderMock).setScan(Mockito.any(Scan.class));
	}
